...
┃▸50⊷ Birthday cake
╰━━━━━━━━━━━━━━━⪼
> *© ᴄʀᴇᴀᴛᴇᴅ ʙʏ Pᴏᴡᴇʀᴇᴅ Bʏ Cʜᴀᴍɪ EᴅɪᴛZ*`;


    // Send the message
    const sentMessage = await conn.sendMessage(from,{image: {url: `https://raw.githubusercontent.com/Ubalasiya/Chamihelper/refs/heads/main/chami-md-main.jpg`},caption: messageText,
    contextInfo: {
      ...
      if (message.message.extendedTextMessage.contextInfo && message.message.extendedTextMessage.contextInfo.stanzaId === sentMessage.key.id) {
        ...
        if (logoUrl) {
          await conn.sendMessage(from, {
            image: { url: logoUrl },
            caption: `*ᴄʀᴇᴀᴛᴇᴅ ʙʏ Cʜᴀᴍɪ EᴅɪᴛZ*`,
          }, { quoted: mek });
        }
      }
    });
      ...
      if (msg.message.extendedTextMessage.contextInfo &&
        ...
        if (logoUrls[userResponse]) {
          ...
          await conn.sendMessage(from, {
            ...
            caption: "*ᴄʀᴇᴀᴛᴇᴅ ʙy Cʜᴀᴍɪ EᴅɪᴛZ*",
          contextInfo: {
                mentionedJid: ['94766315540@s.whatsapp.net'], // specify mentioned JID(s) if any
                groupMentions: [],
                forwardingScore: 1,
